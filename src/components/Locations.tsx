...
function LocationCard({ district, address, phones, image }: { district: string, address: string, phones: string[], image: string }) {
    return (
        <div className="group rounded-2xl overflow-hidden shadow-lg border border-slate-100 bg-white">
