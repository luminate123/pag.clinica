    ...
    <section id="nosotros" className="py-24 bg-slate-50">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center gap-16">
          ...
          <div className="w-full md:w-1/2">
            <span className="text-sm uppercase tracking-widest text-slate-500 mb-2 block">Sobre Nosotros</span>
            <h2 className="text-3xl md:text-4xl font-serif text-slate-900 mb-6">Compromiso con la Estética y la Salud</h2>
